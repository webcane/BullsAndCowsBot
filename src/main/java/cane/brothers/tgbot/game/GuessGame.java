...
class GuessGame {
     ...
     * @param finished   if game already finished
     */
    @PersistenceCreator
    GuessGame(UUID gameId, int complexity, IGuessNumber secret, int ordinal, Collection<GuessTurn> turns, boolean finished) {
        this.gameId = gameId;
